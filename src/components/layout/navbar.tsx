...
export default function Navbar() {
  const menu = [
    ...
    { title: "Bino / Qavat / Xona", link: "/buildings" },
  ...
  return (
    <header className="w-full h-16 bg-white border-b border-gray-400 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <NavLink to={"settings"} className="p-2 border rounded-xl hover:bg-gray-100 border-gray-400 cursor-pointer">
          <Settings size={18} />
        </NavLink>

        <button onClick={logout} className="p-2 bg-red-500 text-white rounded-xl hover:bg-red-600 cursor-pointer">
          <LogOut size={18} />
        </button>
